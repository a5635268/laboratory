      ...
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          <el-form-item label="编码" prop="articleId">
            <el-input v-model="queryParams.articleId" placeholder="请输入编码" clearable
        ...
        <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="编码" align="center" prop="articleId"
          ...
          <el-table-column label="状态" align="center" prop="status"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="发布时间" align="center" prop="publishAt"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="创建时间" align="center" prop="createdAt"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="" align="center" prop="updatedAt"
                           :show-overflow-tooltip="true"/>
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
          <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="内容2" prop="content">
              <tinymce v-model="form.content" placeholder="请输入编辑器" :height="300"></tinymce>
            </el-form-item>
...
<script>
import {addArticle, delArticle, getArticle, listArticle, updateArticle} from '@/api/article'
